 ...
 ********************************************************************/
    ...
    BYTE NVMInit( void )
    {
        ...
        #ifdef ENABLE_DEBUG
            UART2PutROMString((ROM char * const)"NVMInit started...\r\n");
        #endif
        ...
        {
            #ifdef ENABLE_DEBUG
                UART2PutROMString((ROM char * const)"Initializing EE...\r\n");
            #endif
        ...
        #ifdef ENABLE_DEBUG
            UART2PutROMString((ROM char * const)"NVMInit complete.\r\n");
        #endif
 ...
 ********************************************************************/
    ...
    BYTE ComparePage( WORD dest,  BYTE *src, WORD count )
    {
        ...
        do
        {
            ...
            #ifdef ENABLE_DEBUG
                UART2PutROMString((ROM char * const)"Want ");
                PrintChar(*src);
                UART2PutROMString((ROM char * const)"Got ");
                PrintChar(oneByte);
                UART2Put( ' ' );
            #endif
            if (oneByte != *src)
